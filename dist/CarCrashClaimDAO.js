...
var _CarCrashClaimDAOSol = require("../contracts/CarCrashClaimDAO.sol.js");
...
var MiniMeToken = function () {
    function MiniMeToken(web3, address) {
        ...
        this.web3 = web3;
        this.contract = this.web3.eth.contract(_CarCrashClaimDAOSol.MiniMeTokenAbi).at(address);
    }
    ...
    _createClass(MiniMeToken, [{
        ...
        value: function deploy(web3, opts, _cb) {
            return (0, _runethtx.asyncfunc)(function (cb) {
                ...
                _async2.default.series([function (cb1) {
                    params.abi = _CarCrashClaimDAOSol.MiniMeTokenFactoryAbi;
                    params.byteCode = _CarCrashClaimDAOSol.MiniMeTokenFactoryByteCode;
                    ...
                    params.abi = _CarCrashClaimDAOSol.MiniMeTokenAbi;
                    params.byteCode = _CarCrashClaimDAOSol.MiniMeTokenByteCode;
...
var CarCrashClaimDAO = function () {
    function CarCrashClaimDAO(web3, address) {
        _classCallCheck(this, CarCrashClaimDAO);

        this.web3 = web3;
        this.contract = this.web3.eth.contract(_CarCrashClaimDAOSol.CarCrashClaimDAOAbi).at(address);
    }

    _createClass(CarCrashClaimDAO, [{
        key: "uploadClaim",
        value: function uploadClaim(opts, _cb) {
            var _this5 = this;
            ...
            return (0, _runethtx.asyncfunc)(function (cb) {
                ...
                console.log(params);
                _async2.default.series([function (cb1) {
                    _this5.contract.uploadClaim(params.ipfsPdfURL, params.faultCompany, params.nonFaultCompany, {
        ...
        value: function deploy(web3, opts, _cb) {
            return (0, _runethtx.asyncfunc)(function (cb) {
                ...
                var minime = void 0;
                _async2.default.series([function (cb1) {
                    MiniMeToken.deploy(web3, params, function (err, res) {
                        delete params.tokenName;
                        delete params.decimalUnits;
                        delete params.tokenSymbol;
                        minime = res.contract;
                        params.moduleTokenAddress = res.contract.address;
                        params.abi = _CarCrashClaimDAOSol.CarCrashClaimDAOAbi;
                        params.byteCode = _CarCrashClaimDAOSol.CarCrashClaimDAOByteCode;
                        (0, _runethtx.deploy)(web3, params, cb1);
                    });
                }], function (err, res) {
                    if (err) {
                    ...
                    var dao = res[0];
                    minime.changeController(dao.address, {
                        from: web3.eth.accounts[0],
                        amount: 0,
                        gas: 1000000
                    });
    ...
    return CarCrashClaimDAO;
}();

exports.default = CarCrashClaimDAO;
