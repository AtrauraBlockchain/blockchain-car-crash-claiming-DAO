...
import {
    CarCrashClaimDAOAbi,
    CarCrashClaimDAOByteCode,
    MiniMeTokenAbi,
    MiniMeTokenByteCode,
    MiniMeTokenFactoryAbi,
    MiniMeTokenFactoryByteCode,
} from "../contracts/CarCrashClaimDAO.sol.js";
...
export default class CarCrashClaimDAO {

    constructor(web3, address) {
        this.web3 = web3;
        this.contract = this.web3.eth.contract(CarCrashClaimDAOAbi).at(address);
    } 
    ...
    uploadClaim(opts, _cb) {
        return asyncfunc((cb) => {
            const params = Object.assign({}, opts);
            console.log(params);
            async.series([
                (cb1) => {
                    this.contract.uploadClaim(params.ipfsPdfURL, params.faultCompany, params.nonFaultCompany,
                    {
                        from: web3.eth.accounts[0],
                        amount: 0,
                        gas: 1000000,
